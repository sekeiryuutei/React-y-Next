            ...
            <ContentWrapper>
                <div className="content-heading">
                    ...
                    <div className="ml-auto">
                        <Link href={`/forum/topics?catid=${this.params.catid}`} as={`/forum/topics/${this.params.catid}`}>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td className="text-center" style={{width: '15%'}}>
                                    <div className="mt-2">
                                        <a href="">
                                            <img className="rounded-circle thumb64" src="/static/img/user/01.jpg" alt="avatar"/>
                                        </a>
                                    </div>
                            ...
                            <tr>
                                <td className="text-center">
                                    <div className="mt-2">
                                        <a href="">
                                            <img className="rounded-circle thumb64" src="/static/img/user/02.jpg" alt="avatar"/>
                                        </a>
                                    </div>
                            ...
                            <tr>
                                <td className="text-center">
                                    <div className="mt-2">
                                        <a href="">
                                            <img className="rounded-circle thumb64" src="/static/img/user/03.jpg" alt="avatar"/>
                                        </a>
                                    </div>
                            ...
                            <tr>
                                <td className="text-center">
                                    <div className="mt-2">
                                        <a href="">
                                            <img className="rounded-circle thumb64" src="/static/img/user/04.jpg" alt="avatar"/>
                                        </a>
                                    </div>
                            ...
                            <tr>
                                <td className="text-center">
                                    <div className="mt-2">
                                        <a href="">
                                            <img className="rounded-circle thumb64" src="/static/img/user/05.jpg" alt="avatar"/>
                                        </a>
                                    </div>
...
export default withRouter(ForumDiscussion);
