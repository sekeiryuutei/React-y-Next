...
// Used for React select to generate consisten id on client/server
...
if (typeof window !== 'undefined') {
    blocksFromHTML = convertFromHTML('<p>Write something...</p>');
                        ...
                        <form method="get" action="#" className="form-horizontal">
                                                ...
                                                {this.state.displayColorPickerInput ? (
                                                    <div style={popover}>
                                                        <div
                                                            style={cover}
                                                            onClick={
                                                                this.colorpickerInputHandleClose
                                                            }
                                                        />
                                                        <SketchPicker
                                                            renderers={{ canvas: Canvas }}
                                ...
                                <div className="form-group row">
                                    ...
                                    <Col md={10}>
                                        ...
                                        <div className="text-sm text-muted">
                                            Mask placeholder characters can be escaped with a
                                            leading <code>\</code> to use them as static contents
                                        </div>
                            ...
                            <fieldset>
                                <div className="form-group row">
                                    ...
                                    <Col md={10}>
                                        ...
                                        <FormGroup>
                                            <Label for="exampleCustomFileBrowser2">
                                        ...
                                        <FormGroup>
                                            <Label for="exampleCustomFileBrowser3">
                            ...
                            <fieldset>
                                <div className="form-group row">
                                    ...
                                    <Col md={10}>
                                        {/* See above: Editor states is available on client side only */}
                                        {editorState && (
                                            <>
                                                <Editor
