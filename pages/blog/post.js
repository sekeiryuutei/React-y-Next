                ...
                <Row>
                    ...
                    <Col xl="9">
                        <Card className="card-default">
                            ...
                            <CardBody className="text-md">
                                ...
                                <Row>
                                    <Col xs="3">
                                        <a href="">
                                            <img className="img-fluid" src="/static/img/bg4.jpg" alt="Demo"/>
                                        </a>
                                    </Col>
                                    <Col xs="3">
                                        <a href="">
                                            <img className="img-fluid" src="/static/img/bg5.jpg" alt="Demo"/>
                                        </a>
                                    </Col>
                                    <Col xs="3">
                                        <a href="">
                                            <img className="img-fluid" src="/static/img/bg7.jpg" alt="Demo"/>
                                        </a>
                                    </Col>
                                    <Col xs="3">
                                        <a href="">
                                            <img className="img-fluid" src="/static/img/bg8.jpg" alt="Demo"/>
                                        </a>
                                    </Col>
                                </Row>
                                <br/>
                        ...
                        <Card>
                            ...
                            <CardBody>
                                <div className="media">
                                    <img className="mr-3 rounded-circle thumb64" src="/static/img/user/01.jpg" alt="Demo"/>
                                ...
                                <hr/>
                                <div className="media">
                                    <img className="mr-3 rounded-circle thumb64" src="/static/img/user/03.jpg" alt="Demo"/>
                                    <div className="media-body mb-3">
                                        ...
                                        <hr/>
                                        <div className="media">
                                            <img className="mr-3 rounded-circle thumb64" src="/static/img/user/06.jpg" alt="Demo"/>
                                            <div className="media-body">
                            ...
                            <Col xs="4" xl="12">
                                ...
                                <Card className="card-default">
                                    ...
                                    <CardBody className="ie-fix-flex">
                                        <a href="">
                                            <img className="img-fluid img-thumbnail" src="/static/img/mockup.png" alt="Demo"/>
                                        </a>
                                    </CardBody>
                                </Card>
                            </Col>
