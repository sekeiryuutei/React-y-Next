...
class ChartRadial extends Component {
    componentDidMount() {
        ...
        window.requestAnimationFrame(() => this.renderknob());
        window.requestAnimationFrame(() => this.renderEasyPie());
    }
            ...
            <ContentWrapper>
                <div className="content-heading">
                    <div>
                        Radial charts
                        <small>
                            Canvas based &amp; No canvas Pure CSS radial progress bars solutions
                        </small>
                    </div>
                </div>
                                ...
                                <Row>
                                    <Col md={3}>
                                        <div className="radial-bar radial-bar-20 radial-bar radial-bar-danger">
                                            <img src="/static/img/user/03.jpg" alt="Thumbnail" />
                                        </div>
                                    </Col>
                                    <Col md={3}>
                                        <div
                                        ...
                                        >
                                            <img src="/static/img/user/01.jpg" alt="Thumbnail" />
                                        </div>
                                    </Col>
                                    <Col md={3}>
                                        <div
                                        ...
                                        >
                                            <img src="/static/img/user/04.jpg" alt="Thumbnail" />
                                        </div>
                                    </Col>
                                    <Col md={3}>
                                        <div
                                        ...
                                        >
                                            <img src="/static/img/user/05.jpg" alt="Thumbnail" />
                                        </div>
                                    </Col>
                                </Row>
                            </CardBody>
