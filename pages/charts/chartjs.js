...
import { Line, Bar, Doughnut, Pie, Polar, Radar } from '@/components/Config/chartjs.setup';
                ...
                <Container fluid className="container-lg">
                    <Row className="mb-3">
                        <Col lg={ 6 }>
                            ...
                            <Card body>
                                { chartReady && <LineChart data={Line.data} options={Line.options} width={600} height={300}/> }
                            </Card>
                        </Col>
                        <Col lg={ 6 }>
                            ...
                            <div>
                                <Card body>
                                    { chartReady && <BarChart data={Bar.data} options={Bar.options} width={600} height={300}/> }
                                </Card>
                            </div>
                        </Col>
                    </Row>
                    <Row className="mb-3">
                        <Col lg={ 6 }>
                            ...
                            <div>
                                <Card body>
                                    { chartReady && <PolarChart data={Polar.data} options={Polar.options} width={600} height={300}/> }
                                </Card>
                            </div>
                        </Col>
                        <Col lg={ 6 }>
                            ...
                            <div>
                                <Card body>
                                    { chartReady && <RadarChart data={Radar.data} options={Radar.options} width={600} height={300}/> }
                                </Card>
                            </div>
                        </Col>
                    </Row>
                    <Row className="mb-3">
                        <Col lg={ 6 }>
                            ...
                            <div>
                                <Card body>
                                    { chartReady && <PieChart data={Pie.data} options={Pie.options} width={600} height={300}/> }
                                </Card>
                            </div>
                        </Col>
                        <Col lg={ 6 }>
                            ...
                            <div>
                                <Card body>
                                    { chartReady && <DoughnutChart data={Doughnut.data} options={Doughnut.options} width={600} height={300}/> }
                                </Card>
                            </div>
                        </Col>
                    </Row>
