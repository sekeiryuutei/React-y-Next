                        ...
                        <form className="mb-3" name="formLogin" onSubmit={this.onSubmit}>
                            ...
                            <div className="clearfix">
                                ...
                                <div className="float-right">
                                    <Link href="/pages/recover" as="/recover"><a className="text-muted">Forgot your password?</a></Link>
                                </div>
                            </div>
                            <button className="btn btn-block btn-primary mt-3" type="submit">Login</button>
                        </form>
                        <p className="pt-3 text-center">Need to Signup?</p>
                        <Link href="/pages/register" as="/register"><button className="btn btn-block btn-secondary">Register Now</button></Link>
                    </div>
                </div>
