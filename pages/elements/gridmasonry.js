                ...
                <div className="container">
                    ...
                    <CardColumns>
                        <div className="card mb-4">
                            <img className="card-img-top img-fluid" src="/static/img/bg1.jpg" alt="Card cap"/>
                        ...
                        <div className="card mb-4">
                            <img className="card-img-top img-fluid" src="/static/img/bg2.jpg" alt="Card cap"/>
                            <div className="card-body">
                        ...
                        <div className="card mb-4">
                            <img className="card-img img-fluid" src="/static/img/bg3.jpg" alt="Card"/>
                        </div>
                        ...
                        <div className="card mb-4">
                            <img className="card-img-top img-fluid" src="/static/img/bg4.jpg" alt="Card cap"/>
                        </div>
