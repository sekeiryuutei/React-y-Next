    ...
    render = () => (
        <ContentWrapper>
            <div className="card b text-white">
                <div className="card-body bg-cover clearfix" style={{backgroundImage: 'url(/static/img/profile-bg.jpg)'}}>
                    <div className="media mt-0 align-items-center">
                        <img className="mr-3 img-thumbnail rounded-circle thumb96" src="/static/img/user/06.jpg" alt="Demo"/>
            ...
            <div className="card-columns card-columns-2">
                ...
                <div className="card b">
                    <div className="card-header">
                        ...
                        <div className="media mt-0">
                            <img className="mr-2 img-thumbnail rounded-circle thumb32" src="/static/img/user/03.jpg" alt="Demo"/>
                            <div className="media-body">
                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="col-xl-4 text-center mb-3">
                                <a href="">
                                    <img className="img-fluid img-thumbnail" src="/static/img/bg8.jpg" alt="Demo"/>
                                </a>
                            </div>
                ...
                <div className="card b">
                    <div className="card-header">
                        ...
                        <div className="media mt-0">
                            <img className="mr-2 img-thumbnail rounded-circle thumb32" src="/static/img/user/08.jpg" alt="Demo"/>
                            <div className="media-body">
                    ...
                    <div className="card-body">
                        ...
                        <p>
                            <a href="">
                                <img className="img-fluid img-thumbnail" src="/static/img/bg10.jpg" alt="Demo"/>
                            </a>
                        </p>
                        <p>
                        ...
                        <div className="media mb-2">
                            <img className="mr-2 rounded-circle thumb32" src="/static/img/user/05.jpg" alt="Demo"/>
                            <div className="media-body">
                                <span>
                                    <p className="m-0">
                                        <a href="">
                        ...
                        <div className="media mb-2">
                            <img className="mr-2 rounded-circle thumb32" src="/static/img/user/08.jpg" alt="Demo"/>
                            <div className="media-body">
                                <span>
                                    <p className="m-0">
                                        <a href="">
                        ...
                        <div className="media mb-2">
                            <img className="mr-2 rounded-circle thumb32" src="/static/img/user/04.jpg" alt="Demo"/>
                            <div className="media-body">
                                <span>
                                    <p className="m-0">
                                        <a href="">
                    ...
                    <div className="card-header">
                        <div className="float-right">
                            <a className="inline" href="">
                                <img className="rounded-circle thumb24" src="/static/img/user/05.jpg" alt="member"/>
                            </a>
                            <a className="inline" href="">
                                <img className="rounded-circle thumb24" src="/static/img/user/06.jpg" alt="member"/>
                            </a>
                            <a className="inline" href="">
                                <img className="rounded-circle thumb24" src="/static/img/user/07.jpg" alt="member"/>
                            </a>
                        </div>
                        <div className="media mt-0">
                            <img className="mr-2 img-thumbnail rounded-circle thumb32" src="/static/img/user/04.jpg" alt="Demo"/>
                            <div className="media-body">
                ...
                <div className="card b">
                    ...
                    <div className="card-body">
                        <p>
                            <a href="">
                                <img className="img-fluid img-thumbnail" src="/static/img/bg3.jpg" alt="Demo"/>
                            </a>
                        </p>
                        <p>Curabitur dignissim dapibus nisl sed iaculis.</p>
                    </div>
                ...
                <div className="card b">
                    ...
                    <div className="card-body">
                        <a className="inline" href="">
                            <img className="rounded-circle thumb48" src="/static/img/user/03.jpg" alt="member"/>
                        </a>
                        <a className="inline" href="">
                            <img className="rounded-circle thumb24" src="/static/img/user/02.jpg" alt="member"/>
                        </a>
                        <a className="inline" href="">
                            <img className="rounded-circle thumb24" src="/static/img/user/06.jpg" alt="member"/>
                        </a>
                        ...
                        <a className="inline" href="">
                            <img className="rounded-circle thumb24" src="/static/img/user/08.jpg" alt="member"/>
                        </a>
                        <a className="inline" href="">
                            <img className="rounded-circle thumb24" src="/static/img/user/09.jpg" alt="member"/>
                        </a>
                    </div>
                    <div className="card-body">
                        <form className="mb-2 mt-2" method="post" action="">
                            ...
                            <div className="col-6">
                                <div className="row row-flush">
                                    <div className="row row-flush">
                                        <div className="col-6">
                                            <a href="">
                                                <img className="img-fluid img-thumbnail" src="/static/img/bg7.jpg" alt="Demo"/>
                                            </a>
                                        </div>
                                        <div className="col-6">
                                            <a href="">
                                    ...
                                    <div className="col-12">
                                        <a href="">
                                            <img className="img-fluid img-thumbnail" src="/static/img/lock-bg.jpg" alt="Demo"/>
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-6">
                                <div className="row row-flush">
                                    ...
                                    <div className="row row-flush">
                                        <div className="col-6">
                                            <a href="">
                                                <img className="img-fluid img-thumbnail" src="/static/img/bg4.jpg" alt="Demo"/>
                                            </a>
                                        </div>
                                        <div className="col-6">
                                            <a href="">
                                                <img className="img-fluid img-thumbnail" src="/static/img/bg5.jpg" alt="Demo"/>
                                            </a>
                                        </div>
                                    </div>
                                </div>
