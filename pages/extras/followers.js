            ...
            <ContentWrapper>
                ...
                <Row>
                    ...
                    <Col xl="3" lg="4">
                        ...
                        <FollowerCard user name="Todd Evans" location="Rome, Italy" imgsrc="/static/img/user/02.jpg" joined="Feb, 2015"/>
                            ...
                            <CardBody>
                                <div className="media align-items-center">
                                    <a className="mr-2" href="">
                                        <img className="rounded-circle img-thumbnail thumb48" src="/static/img/user/04.jpg" alt="Contact"/>
                                    </a>
                                ...
                                <div className="media align-items-center">
                                    <a className="mr-2" href="">
                                        <img className="rounded-circle img-thumbnail thumb48" src="/static/img/user/05.jpg" alt="Contact"/>
                                    </a>
                                    <div className="media-body pt-1">
                                        <div className="float-right">
                                            <button className="btn btn-secondary btn-sm" type="button">Follow</button>
                                ...
                                <div className="media align-items-center">
                                    <a className="mr-2" href="">
                                        <img className="rounded-circle img-thumbnail thumb48" src="/static/img/user/06.jpg" alt="Contact"/>
                                    </a>
                                    <div className="media-body pt-1">
                                        <div className="float-right">
                                            <button className="btn btn-secondary btn-sm" type="button">Follow</button>
                    ...
                    <Col xl="9" lg="8">
                        <Row>
                            <Col xl="4" lg="6">
                                <FollowerCard name="Savannah Ramirez" location="Rome, Italy" imgsrc="/static/img/user/01.jpg"/>
                            </Col>
                            <Col xl="4" lg="6">
                                <FollowerCard name="Warren Watts" location="Rome, Italy" imgsrc="/static/img/user/03.jpg" following/>
                            </Col>
                            <Col xl="4" lg="6">
                                <FollowerCard name="Charlie Price" location="Rome, Italy" imgsrc="/static/img/user/04.jpg"/>
                            </Col>
                            <Col xl="4" lg="6">
                                <FollowerCard name="Vickie Alvarez" location="Rome, Italy" imgsrc="/static/img/user/05.jpg"/>
                            </Col>
                            <Col xl="4" lg="6">
                                <FollowerCard name="Marjorie Miller" location="Rome, Italy" imgsrc="/static/img/user/06.jpg" following/>
                            </Col>
                            <Col xl="4" lg="6">
                                <FollowerCard name="Tracy Reynolds" location="Rome, Italy" imgsrc="/static/img/user/07.jpg"/>
                            </Col>
                            <Col xl="4" lg="6">
                                <FollowerCard name="Lori Lewis" location="Rome, Italy" imgsrc="/static/img/user/08.jpg"/>
                            </Col>
                            <Col xl="4" lg="6">
                                <FollowerCard name="Judy Shelton" location="Rome, Italy" imgsrc="/static/img/user/09.jpg"/>
                            </Col>
                        </Row>
                    </Col>
                    {/* end Main cards */}
