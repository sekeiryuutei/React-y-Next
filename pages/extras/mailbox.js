                                ...
                                <table className="table table-hover mb-mails">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    <img className="mb-mail-avatar mr-2" alt="Mail Avatar" src="/static/img/user/01.jpg"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    <img className="mr-2 mb-mail-avatar" alt="Mail Avatar" src="/static/img/user/02.jpg"/>
                                                    <div className="mb-mail-meta">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    <img className="mr-2 mb-mail-avatar" alt="Mail Avatar" src="/static/img/user/03.jpg"/>
                                                    <div className="mb-mail-meta">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    <img className="mr-2 mb-mail-avatar" alt="Mail Avatar" src="/static/img/user/04.jpg"/>
                                                    <div className="mb-mail-meta">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    <img className="mr-2 mb-mail-avatar" alt="Mail Avatar" src="/static/img/user/05.jpg"/>
                                                    <div className="mb-mail-meta">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    <img className="mr-2 mb-mail-avatar" alt="Mail Avatar" src="/static/img/user/06.jpg"/>
                                                    <div className="mb-mail-meta">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    <img className="mr-2 mb-mail-avatar" alt="Mail Avatar" src="/static/img/user/07.jpg"/>
                                                    <div className="mb-mail-meta">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    <img className="mr-2 mb-mail-avatar" alt="Mail Avatar" src="/static/img/user/08.jpg"/>
                                                    <div className="mb-mail-meta">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    <img className="mr-2 mb-mail-avatar" alt="Mail Avatar" src="/static/img/user/09.jpg"/>
                                                    <div className="mb-mail-meta">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="d-flex">
                                                    <img className="mr-2 mb-mail-avatar" alt="Mail Avatar" src="/static/img/user/10.jpg"/>
                                                    <div className="mb-mail-meta">
