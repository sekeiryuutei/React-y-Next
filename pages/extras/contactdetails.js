                    ...
                    <Col lg="4">
                        <div className="card card-default">
                            <div className="card-body text-center">
                                <div className="py-4">
                                    <img className="img-fluid rounded-circle img-thumbnail thumb96" src="/static/img/user/02.jpg" alt="Contact"/>
                                </div>
                        ...
                        <div className="card card-default d-none d-lg-block">
                            ...
                            <div className="card-body">
                                <div className="media">
                                    <img className="align-self-center mr-2 rounded-circle img-thumbnail thumb48" src="/static/img/user/04.jpg" alt="Contact"/>
                                ...
                                <div className="media">
                                    <img className="align-self-center mr-2 rounded-circle img-thumbnail thumb48" src="/static/img/user/05.jpg" alt="Contact"/>
                                    <div className="media-body py-2">
                                ...
                                <div className="media">
                                    <img className="align-self-center mr-2 rounded-circle img-thumbnail thumb48" src="/static/img/user/06.jpg" alt="Contact"/>
                                    <div className="media-body py-2">
                                ...
                                <div className="media">
                                    <img className="align-self-center mr-2 rounded-circle img-thumbnail thumb48" src="/static/img/user/07.jpg" alt="Contact"/>
                                    <div className="media-body py-2">
