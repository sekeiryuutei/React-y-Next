    ...
    render() {
        return (
            <ContentWrapper unwrap>
                <div className="bg-cover" style={{backgroundImage: 'url(/static/img/profile-bg.jpg)'}}>
                    <div className="p-4 text-center text-white">
                        <img className="img-thumbnail rounded-circle thumb128" src="/static/img/user/09.jpg" alt="Avatar"/>
                                        ...
                                        <div className="popover left">
                                            ...
                                            <div className="popover-body">
                                                <div className="d-flex align-items-center mb-3">
                                                    <img className="mr-3 rounded-circle thumb48" src="/static/img/user/05.jpg" alt="Avatar"/>
                                                    <p className="m-0">
                                ...
                                <li className="timeline-inverted">
                                    ...
                                    <div className="timeline-card">
                                        <div className="popover right">
                                            ...
                                            <div className="popover-body">
                                                <div className="d-flex align-items-center mb-3">
                                                    <img className="mr-3 rounded-circle thumb48" src="/static/img/user/04.jpg" alt="Avatar"/>
                                                    <p className="m-0">
                                                        <a className="text-muted" href="">
                                                ...
                                                <div className="media bb p-2">
                                                    <img className="mr-2 rounded-circle thumb32" src="/static/img/user/05.jpg" alt="Avatar"/>
                                                ...
                                                <div className="media bb p-2">
                                                    <img className="mr-2 rounded-circle thumb32" src="/static/img/user/08.jpg" alt="Avatar"/>
                                                    <div className="media-body">
                                                        <p className="m-0">
                                                            <a href="">
                                                ...
                                                <div className="media bb p-2">
                                                    <img className="mr-2 rounded-circle thumb32" src="/static/img/user/04.jpg" alt="Avatar"/>
                                                    <div className="media-body">
                                                        <p className="m-0">
                                                            <a href="">
                                                                <strong>James Payne</strong>
                                ...
                                <li>
                                    ...
                                    <div className="timeline-card">
                                        <div className="popover left">
                                            ...
                                            <div className="popover-body">
                                                <div className="d-flex align-items-center mb-3">
                                                    <img className="mr-3 rounded-circle thumb48" src="/static/img/user/08.jpg" alt="Avatar"/>
                                                    <p className="m-0">
                                                        <a className="text-muted" href="">
                                                            <strong>Samantha Murphy</strong>
                                                        </a>
                                ...
                                <li>
                                    ...
                                    <div className="timeline-card">
                                        <div className="popover left">
                                            ...
                                            <div className="popover-body">
                                                <div className="d-flex align-items-center mb-3">
                                                    <img className="mr-3 rounded-circle thumb48" src="/static/img/user/12.jpg" alt="Avatar"/>
                                                    <p className="m-0">
                                                        <a className="text-muted" href="">
                                ...
                                <li className="timeline-inverted">
                                    ...
                                    <div className="timeline-card">
                                        <div className="popover right">
                                            ...
                                            <div className="popover-body">
                                                <div className="d-flex align-items-center mb-3">
                                                    <img className="mr-3 rounded-circle thumb48" src="/static/img/user/09.jpg" alt="Avatar"/>
                                                    <p className="m-0">
                                                        <a className="text-muted" href="">
                                ...
                                <li>
                                    ...
                                    <div className="timeline-card">
                                        <div className="popover left">
                                            ...
                                            <div className="popover-body">
                                                <div className="d-flex align-items-center mb-3">
                                                    <img className="mr-3 rounded-circle thumb48" src="/static/img/user/10.jpg" alt="Avatar"/>
                                                    <p className="m-0">
                                                        <a className="text-muted" href="">
                            ...
                            <div className="card card-default">
                                ...
                                <ListGroup>
                                    ...
                                    <ListGroupItem className="p-2 mt-0 d-flex">
                                        {/* Contact avatar */}
                                        <img className="mr-3 rounded-circle thumb32" src="/static/img/user/05.jpg" alt="Avatar"/>
                                        {/* Contact info */}
                                        <span>
                                    ...
                                    <ListGroupItem className="p-2 mt-0 d-flex">
                                        {/* Contact avatar */}
                                        <img className="mr-3 rounded-circle thumb32" src="/static/img/user/06.jpg" alt="Avatar"/>
                                        {/* Contact info */}
                                        <span>
                                    ...
                                    <ListGroupItem className="p-2 mt-0 d-flex">
                                        {/* Contact avatar */}
                                        <img className="mr-3 rounded-circle thumb32" src="/static/img/user/07.jpg" alt="Avatar"/>
                                        {/* Contact info */}
                                        <span>
                                    ...
                                    <ListGroupItem className="p-2 mt-0 d-flex">
                                        {/* Contact avatar */}
                                        <img className="mr-3 rounded-circle thumb32" src="/static/img/user/08.jpg" alt="Avatar"/>
                                        {/* Contact info */}
                                        <span>
