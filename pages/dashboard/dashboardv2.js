...
import TooltipWrapper, { resetUUID } from '@/components/Common/TooltipWrapper.js';
...
class DashboardV2 extends Component {
    ...
    render() {
        ...
        resetUUID(); // needed to sync client/server
                                ...
                                <div className="d-flex align-items-center py-3">
                                    ...
                                    <div className="w-50 px-3 text-center">
                                        <div className="d-flex align-items-center flex-wrap justify-content-center">
                                            <TooltipWrapper placement="top" content="Katie">
                                                <img src="/static/img/user/02.jpg" alt="Follower" className="circle thumb24 mx-1" />
                                            </TooltipWrapper>
                                            <TooltipWrapper placement="top" content="Cody">
                                                <img src="/static/img/user/01.jpg" alt="Follower" className="circle thumb24 mx-1" />
                                            </TooltipWrapper>
                                            <TooltipWrapper placement="top" content="Tamara">
                                                <img src="/static/img/user/03.jpg" alt="Follower" className="circle thumb24 mx-1" />
                                            </TooltipWrapper>
                                            <TooltipWrapper placement="top" content="Gene">
                                                <img src="/static/img/user/04.jpg" alt="Follower" className="circle thumb24 mx-1" />
                                            </TooltipWrapper>
                                            <TooltipWrapper placement="top" content="Marsha">
                                                <img src="/static/img/user/04.jpg" alt="Follower" className="circle thumb24 mx-1" />
                                            </TooltipWrapper>
                                            <TooltipWrapper placement="top" content="Robin">
                                                <img src="/static/img/user/09.jpg" alt="Follower" className="circle thumb24 mx-1" />
                                            </TooltipWrapper>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table className="wd-wide">
                            <tbody>
                                <tr>
                                    <td className="wd-xs">
                                        <div className="px-2">
                                            <img className="static/img-fluid rounded thumb64" src="/static/img/dummy.png" alt="Dummy" />
                                        </div>
                                    </td>
                                    <td>
                                        <div className="px-2">
