                                    ...
                                    <div className="row mb-3 pb-3 bb">
                                        <div className="col-6 col-md-3">
                                            <a href="" title="Product 1">
                                                <img className="img-fluid" src="/static/img/bg7.jpg" alt="Product 1"/>
                                            </a>
                                        </div>
                                    ...
                                    <div className="row mb-3 pb-3 bb">
                                        <div className="col-6 col-md-3">
                                            <a href="" title="Product 2">
                                                <img className="img-fluid" src="/static/img/bg8.jpg" alt="Product 1"/>
                                            </a>
                                        </div>
                                        <div className="col-6 col-md-9">
                                            <fieldset>
                                    ...
                                    <div className="row mb-3 pb-3">
                                        <div className="col-6 col-md-3">
                                            <a href="" title="Product 3">
                                                <img className="img-fluid" src="/static/img/bg10.jpg" alt="Product 1"/>
                                            </a>
                                        </div>
                                        <div className="col-6 col-md-9">
                                            <fieldset>
