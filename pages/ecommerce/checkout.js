                                            ...
                                            <CardBody id="collapse02">
                                                ...
                                                <div className="my-2">
                                                    <div className="c-radio">
                                                        <label>
                                                            <input id="chk-guest1" type="radio" name="checkout-ship-to" defaultValue="address"/>
                                                            <span className="fa fa-check"></span>Ship to this address</label>
                                                    </div>
                                                    <div className="c-radio">
                                                        <label>
                                                            <input id="chk-guest2" type="radio" name="checkout-ship-to" defaultValue="other"/>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div className="c-radio">
                                                                    <label>
                                                                        <input id="chk-guest4" type="radio" name="checkout-ship" defaultValue="free"/>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div className="c-radio">
                                                                    <label>
                                                                        <input id="chk-guest5" type="radio" name="checkout-ship" defaultValue="std"/>
                                                                        <span className="fa fa-check"></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div className="c-radio">
                                                                    <label>
                                                                        <input id="chk-guest6" type="radio" name="checkout-ship" defaultValue="next"/>
                                                                        <span className="fa fa-check"></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                ...
                                                <Row>
                                                    <Col xl="6">
                                                        <div className="form-group">
                                                            <div className="c-radio">
                                                                <label>
                                                                    <input className="form-control" id="chk-guest7" type="radio" name="checkout-pay" defaultValue="paypal" defaultChecked/>
                                                        ...
                                                        <div className="form-group">
                                                            <div className="c-radio">
                                                                <label>
                                                                    <input className="form-control" id="chk-guest8" type="radio" name="checkout-pay" defaultValue="check"/>
                                                        ...
                                                        <div className="form-group">
                                                            <div className="c-radio">
                                                                <label>
                                                                    <input className="form-control" id="chk-guest9" type="radio" name="checkout-pay" defaultValue="creditcard"/>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td className="order-pic thumb64">
                                                                    <img src="/static/img/dummy.png" alt="dummy"/>
                                                                </td>
