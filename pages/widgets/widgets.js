            ...
            <ContentWrapper>
                ...
                <div className="row">
                        ...
                        <div className="card">
                            <div className="half-float ie-fix-flex">
                                ...
                                <div className="half-float-bottom">
                                    <img className="img-thumbnail circle thumb128" src="/static/img/user/09.jpg" alt="Demo" />
                                </div>
                            </div>
                   ...
                   <div className="col-xl-4">
                        {/* START card */}
                        <div className="card">
                            <div className="card-body text-center bg-center" style={{backgroundImage: "url('/static/img/bg4.jpg')"}}>
                                <div className="row">
                                    <div className="col-12 text-white">
                                        <img className="img-thumbnail circle thumb128" src="/static/img/user/06.jpg" alt="Demo" />
                    ...
                    <div className="col-xl-4">
                        ...
                        <div className="card">
                            <div className="row row-flush" style={{minHeight: '100%'}}>
                                <div className="col-8">
                                    <img className="img-fluid" src="/static/img/bg1.jpg" alt="Demo" />
                                </div>
                ...
                <div className="row">
                    <div className="col-xl-4">
                        ...
                        <div className="card">
                            <div className="row row-flush">
                                <div className="col-5 d-flex align-items-center justify-content-center" style={{backgroundImage: "url('/static/img/bg2.jpg')", backgroundSize: 'cover'}}></div>
                                <div className="col-7">
                                    <div className="p-3">
                    ...
                    <div className="col-xl-4">
                        ...
                        <div className="card">
                            <div className="card-body bg-danger text-center">
                                ...
                                <img className="img-thumbnail circle thumb96" src="/static/img/user/06.jpg" alt="Demo" />
                ...
                <div className="row">
                    <div className="col-xl-4">
                        {/* START card- */}
                        <div className="card">
                            <img className="img-fluid ie-fix-flex" src="/static/img/bg1.jpg" alt="Demo" />
                            <div className="card-body">
                                <div className="row text-center">
                                    <div className="col-4">
                                        <p>Comments</p>
                            ...
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-6 text-center">
                                        <img className="circle thumb96" src="/static/img/user/09.jpg" alt="Demo" />
                                    </div>
                                    <div className="col-6">
                            ...
                            <div className="card-body">
                                <div className="row align-items-center">
                                    <div className="col-5 text-center">
                                        <img className="img-thumbnail circle img-fluid thumb96" src="/static/img/user/06.jpg" alt="Demo" />
                                    </div>
                                    <div className="col-7">
                    ...
                    <div className="col-xl-4">
                        ...
                        <div className="row">
                                ...
                                <div className="card bg-danger">
                                    <div className="card-body text-center">
                                        <div className="radial-bar radial-bar-40 radial-bar radial-bar-danger m-0">
                                            <img src="/static/img/user/03.jpg" alt="Demo" />
                                        </div>
                                        <p>
                                            <strong>40%</strong>
                                            <span>complete</span>
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="card bg-purple">
                                    <div className="card-body text-center">
                                        <p className="mb-3">
                                            <img className="rounded thumb64" src="/static/img/user/08.jpg" alt="Demo" />
                                        </p>
                                        <p className="m-0">
                                            <strong>Mika</strong>
                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="d-flex align-items-center">
                                    <div className="text-center">
                                        <img className="img-thumbnail circle img-fluid thumb64" src="/static/img/user/06.jpg" alt="Demo" />
                                    </div>
                                    <div className="text-center">
